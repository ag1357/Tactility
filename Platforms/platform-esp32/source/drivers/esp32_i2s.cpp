...
struct Esp32I2sInternal {
    ...
    bool init_pins(Esp32I2sConfig* dts_config) {
        ...
        bool success = acquire_pin_or_set_null(ws_spec, GPIO_FLAG_DIRECTION_OUTPUT, &ws_descriptor, GPIO_OWNER_PERIPHERAL) &&
            acquire_pin_or_set_null(bclk_spec, GPIO_FLAG_DIRECTION_OUTPUT, &bclk_descriptor, GPIO_OWNER_PERIPHERAL) &&
            acquire_pin_or_set_null(data_in_spec, GPIO_FLAG_DIRECTION_INPUT, &data_in_descriptor, GPIO_OWNER_PERIPHERAL) &&
            acquire_pin_or_set_null(data_out_spec, GPIO_FLAG_DIRECTION_OUTPUT, &data_out_descriptor, GPIO_OWNER_PERIPHERAL) &&
            acquire_pin_or_set_null(mclk_spec, GPIO_FLAG_DIRECTION_OUTPUT, &mclk_descriptor, GPIO_OWNER_PERIPHERAL);
