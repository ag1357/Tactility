...
void AetherChatApp::stop() {
    link.stop();
}

void AetherChatApp::showView(lv_obj_t* parent) {
    view.init(parent);
}
...
void createWidgets(lv_obj_t* parent, void* userData) {
    static_cast<AetherChatApp*>(userData)->showView(parent);
}
...
int32_t appMain(int argc, char* argv[]) {
    ...
    WindowId window = window_manager_create(appInstanceId, createWidgets, &app);
